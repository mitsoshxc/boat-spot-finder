...
| [`docs/features/audit-logging.md`](docs/features/audit-logging.md) | NLog audit logger — IAuditLogger contract, log schema, full audited-action catalog across all controllers, nlog.config targets and rules |
