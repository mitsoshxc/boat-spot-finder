...
namespace BoatSpotFinder.Infrastructure.Migrations
{
    ...
    [Migration("20260603175840_AddBookingDismissedByMarina")]
    partial class AddBookingDismissedByMarina
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BoatSpotFinder.Core.Entities.ApplicationUser", b =>
                {
                    ...
                    b.Property<decimal?>("AverageRatingAsBoatOwner")
                        .HasPrecision(18, 2)
                    ...
                    b.Property<int>("ReviewCountAsBoatOwner")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasDefaultValue(0);
            ...
            modelBuilder.Entity("BoatSpotFinder.Core.Entities.Booking", b =>
                {
                    ...
                    b.Property<bool>("DismissedByMarina")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);

                    b.Property<bool>("DismissedByOwner")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("BoatSpotFinder.Core.Entities.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BookingId", "ReviewerRole")
                        .IsUnique();

                    b.ToTable("Reviews", t =>
                        {
                            t.HasCheckConstraint("CK_Reviews_Score", "[Score] BETWEEN 1 AND 5");
                        });
                });
            ...
            modelBuilder.Entity("BoatSpotFinder.Core.Entities.Review", b =>
                {
                    b.HasOne("BoatSpotFinder.Core.Entities.Booking", "Booking")
                        .WithMany("Reviews")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BoatSpotFinder.Core.Entities.ApplicationUser", "Reviewer")
                        .WithMany()
